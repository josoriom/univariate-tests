...
describe('test grubbs function 8 values', () => {
  ...
  it('Test 2 outlier', () => {
    ...
    expect(test[0].result).toBeDeepCloseTo(0.20609918, 8);
    expect(test[0].pass).toStrictEqual(true);
    expect(test[1].result).toBeDeepCloseTo(0.29685652, 8);
    expect(test[1].pass).toStrictEqual(true);
    expect(test[2].result).toBeDeepCloseTo(0.38758372, 8);
    expect(test[2].pass).toStrictEqual(true);
    expect(test[3].result).toBeDeepCloseTo(2.23446244, 8);
